...
\authorinfo{Francisco Sant'Anna\and Adriano Branco\and Roberto Ierusalimschy\and Noemi Rodriguez}
           {Departamento de Inform\'atica, PUC--Rio}
           {\{fsantanna,abranco,roberto,noemi\}@inf.puc-rio.br}
\authorinfo{Silvana Rossetto}
...
%Note that in contrast with a \code{par/and}, a \code{par/hor} rejoins during 
%the same reaction in which one of the sides terminates, but also allows the 
%other side to run before.
